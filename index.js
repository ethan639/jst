// <!--GAMFC-->version base on commit 43fad05dcdae3b723c53c226f8181fc5bd47223e, time is 2024-07-30 UTC<!--GAMFC-END-->.
// @ts-ignore
import { connect } from "cloudflare:sockets";

// How to generate your own UUID:
// [Windows] Press "Win + R", input cmd and run:  Powershell -NoExit -Command "[guid]::NewGuid()"
let userID = "ca284744-081d-40a9-a97a-0d75bf1a7c99";

const proxyIPs = ["146.70.169.118","146.70.175.186","47.236.130.95","43.153.80.208"]; 
const cn_hostnames = [''];
...
function getVLESSConfig(userID, hostName) {
  const wvlessws = `vless://${userID}\u0040${CDNIP}:80?encryption=none&security=none&type=ws&host=${hostName}&path=%2F%3Fed%3D2560#mg`;
  const pvlesswstls = `vless://${userID}\u0040${CDNIP}:443?encryption=none&security=tls&type=ws&host=${hostName}&sni=${hostName}&fp=randomized&path=%2F%3Fed%3D2560#mgs`;
...
function gettyConfig(userID, hostName) {
	const vlessshare = btoa(`vless://${userID}\u0040${IP1}:${PT1}?encryption=none&security=none&fp=randomized&type=ws&host=${hostName}&path=%2F%3Fed%3D2560#CF_V1\n
...
function getptyConfig(userID, hostName) {
	const vlessshare = btoa(`vless://${userID}\u0040${IP8}:${PT8}?encryption=none&security=tls&sni=${hostName}&fp=randomized&type=ws&host=${hostName}&path=%2F%3Fed%3D2560#CF_V8\n
	vless://${userID}\u0040${IP9}:${PT9}?encryption=none&security=tls&sni=${hostName}&fp=randomized&type=ws&host=${hostName}&path=%2F%3Fed%3D2560#CF_V9\n
	vless://${userID}\u0040${IP10}:${PT10}?encryption=none&security=tls&sni=${hostName}&fp=randomized&type=ws&host=${hostName}&path=%2F%3Fed%3D2560#CF_V10\n
	vless://${userID}\u0040${IP11}:${PT11}?encryption=none&security=tls&sni=${hostName}&fp=randomized&type=ws&host=${hostName}&path=%2F%3Fed%3D2560#CF_V11\n
	vless://${userID}\u0040${IP12}:${PT12}?encryption=none&security=tls&sni=${hostName}&fp=randomized&type=ws&host=${hostName}&path=%2F%3Fed%3D2560#CF_V12\n
